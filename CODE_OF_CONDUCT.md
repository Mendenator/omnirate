...
requests, discussions, and any other channel used for the project), and
...
[private security advisory](https://github.com/Mendenator/omnirate/security/advisories/new)
on the repository (this reaches maintainers privately, unlike a normal
issue). All complaints will be reviewed and investigated promptly and
fairly.
