...
> 📄 Техникийн бус тайлбар хайж байвал: **[Мэргэжлийн бус хүнд зориулсан тайлан](https://claude.ai/artifact/Ej7rN32MerYjb6LBZ46krC)**.
...
1. ~~`npm install` / `uv sync` хийж бодит орчинд шалгах~~ — **хийгдсэн**, доор.
2. Гадаад хамаарлууд шийдэгдэх (доор жагсаасан — зарим нь одоо бодит эх сурвалжтай).
...
## Аюулгүй байдлын автомат шалгалт

`pip-audit` (backend), `npm audit` (web, mobile) бодитоор ажиллуулж шалгасан — мэргэжлийн pentest-ийн орлуулагч биш, гэхдээ бодит, ашигтай эхний давхарга:

- **Backend: 0 мэдэгдэж буй эмзэг тал.** Нэг олдсон асуудлыг (`ecdsa` сангийн timing-side-channel сул тал, `python-jose`-ийн transitive dependency) шалгаж үзэхэд манай код HS256 (HMAC) л ашигладаг тул тухайн эмзэг замыг огт хэрэглэдэггүй байсан ч, `python-jose`-г `PyJWT`-ээр сольж `ecdsa`-г бүрмөсөн хассан (жижиг, илүү аюулгүй dependency). Мөн `PyJWT` илүү хатуу шалгадаг тул JWT нууц түлхүүрийн урт 32 байтаас багавтар байгааг илрүүлж, dev/prod-д зориулсан баталгаажуулалт нэмсэн (production орчинд сул нууц түлхүүрээр асахгүй болсон).
- **Web: 2 мэдэгдэж буй эмзэг тал** (`postcss`, Next.js-ийн дотоод хамаарал) — засахад Next.js-ийг 15→16 major хувилбар болгож ахиулах шаардлагатай, энэ бол эвдрэл учруулж болзошгүй том өөрчлөлт тул нэг талын шийдвэрээр хийгээгүй.
- **Mobile: 25 мэдэгдэж буй эмзэг тал** (Expo/React Native экосистемийн дотоод хамаарлууд) — бүгд Expo SDK-ийн major хувилбар ахиулахыг шаарддаг тул адилхан хийгээгүй.

## Гадаад хамаарлын жагсаалт

### Бодит эх сурвалж олдож, баримтжуулсан (гэхдээ гэрээ/зөвшөөрөл авах нь захиалагчийн байгууллагын үйлдэл шаарддаг)

1. **ДАН систем (танилт-нэвтрэлт)** — Үндэсний Дата Төвийн ([datacenter.gov.mn/service/dan](https://datacenter.gov.mn/service/dan)) удирдлаган дор ажилладаг OAuth2 протокол ашигладаг систем. Шинээр холбогдох, эсвэл шинэ сервис нэмэхэд **geree.gov.mn** цахим гэрээний системээр албан ёсны хүсэлт гаргана. Техникийн гарын авлага: [guide.datacenter.gov.mn/books/tanilt-nevtreltiin-dan-sistemiin-garyn-avlaga](https://guide.datacenter.gov.mn/books/tanilt-nevtreltiin-dan-sistemiin-garyn-avlaga), хөгжүүлэгчийн портал: [developer.e-mongolia.mn](https://developer.e-mongolia.mn/). Холбоо барих: `info@datacenter.gov.mn`, техникийн асуулт: `development@datacenter.gov.mn`, аюулгүй байдал: `security@datacenter.gov.mn`. Client ID/Secret/Redirect URI бүртгүүлж, серверийн цаг UTC+08:00-тэй тохирсон байх шаардлагатай (grant хугацаа 60 секундэд дуусдаг).
2. **е-баримт (PosAPI 3.0)** — Мэдээллийн технологийн газрын ([itc.gov.mn](https://itc.gov.mn)) хөгжүүлэгчийн портал: [developer.itc.gov.mn/docs/ebarimt-api](https://developer.itc.gov.mn/docs/ebarimt-api/). Албан ёсны PDF заавар: [share.itc.gov.mn/share/developer/POS API 3.0.1.pdf](https://share.itc.gov.mn/share/developer/POS%20API%203.0.1.pdf). Систем REST API ашигладаг, Postman collection бэлэн байдаг. e-tax системд хандах эрхгүй бол харьяалагдах татварын албатай холбогдож эрх авна. Нээлттэй эх сурвалж жишээ код: [github.com/hurelhuyag/ebarimt](https://github.com/hurelhuyag/ebarimt) (staging endpoint: `stg-invoice.ebarimt.mn`).

**Анхаарах зүйл:** Дээрх мэдээллийг эх сурвалжаас олж баталгаажуулсан ч, **бодит гэрээ байгуулах, Client ID/Secret авах ажиллагааг зөвхөн OmniRate-ийг эзэмшигч хуулийн этгээд өөрөө хийж чадна** — код бичигч (AI ч бай, хүн ч бай) байгууллагын нэрийн өмнөөс төрийн байгууллагатай гэрээ байгуулах эрхгүй.

### Бодит хүн, гэрээ, эрх мэдэл шаарддаг тул эх сурвалжаас "олж" шийдэх боломжгүй

3. **Хуульч** — DPIA, зөвшөөрлийн текст, moderation policy, P3-09 эцсийн хяналтыг зөвхөн лицензтэй Монгол Улсын хуульч баталгаажуулж чадна. AI хуулийн дүгнэлт гаргах нь хуурамч, хариуцлагагүй хууль зүйн зөвлөгөө болно.
4. **Pentester** — OWASP ASVS L2 түвшний мэргэжлийн нэвтрэлтийн шалгалт (P1-18) гар аргаар, гэрчилгээтэй мэргэжилтнээр хийгдэх ёстой. Дээрх автомат dependency scan үүний орлуулагч биш, зөвхөн эхний давхарга.
5. **Тэмдэглэгчид** — 15,000 moderation дээж, gold set (P0-12, S-08) — бодит хүний тэмдэглэлт өгөгдөл, симуляц хийх боломжгүй.
6. **Бодит хэрэглэгчид** — card sorting/tree test (S-01), usability тест (K12, S-16, S-20), red-team (K4/K5, P2-14), хаалттай бета 1,000 хэрэглэгч (P3-10), moderator сургалт (P3-08) — эдгээрт "хиймэл хэрэглэгч" ашиглах нь үр дүнг хуурамчаар гаргана.
...
8. **LLM moderation endpoint** — P2-05 нь бодит Anthropic/OpenAI API түлхүүр тохируулаагүй (аккаунт, төлбөрийн эрх шаардана).
9. **LightGBM fraud загвар** — синтетик өгөгдөр дээр AUC>0.9 батлагдсан ч бодит SOW acceptance зөвхөн бодит fraud/normal өгөгдөр дээр дахин сургаж баталгаажна.
10. **Ирцийн (P3-03) эх сурвалж** — SOW өөрөө "Өгөгдлийн эх сурвалж" гэж тодорхойгүй үлдээсэн; тодорхой засгийн газрын open-data API сонгогдоогүй.
11. **Role-based auth** — moderator/law-enforcement эрхийн систем (P2-12, P3-06) одоогоор аль ч аутентификациятай хэрэглэгчид нээлттэй; production-д гарахаас өмнө заавал битүүлэх ёстой (P3 admin-hardening даалгавар, SOW-д тусад нь дурдагдаагүй ч зайлшгүй).
