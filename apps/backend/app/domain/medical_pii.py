...
_DRUG_NAMES = {
    "парацетамол", "ибупрофен", "амоксициллин", "аспирин", "омепразол",
    "метформин", "инсулин", "лоратадин", "цетиризин", "дексаметазон",
    "преднизолон", "азитромицин", "ципрофлоксацин", "но-шпа", "анальгин",
}
